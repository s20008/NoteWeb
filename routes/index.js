...
//获取便签类型列表
router.get('/getNoteTypeList', function (req, res) {
  noteTypeModel.find(function (err, data) {
    if (!err) {
      res.send(data)
    } else {
...
//获取指定便签列表数据
router.get('/getNoteList', function (req, res) {
...
//获取对应便签的内容
router.get('/getNnoteList', function (req, res) {
...
//获取对应便签的投稿内容
router.get('/getContributionList', function (req, res) {
...
//获取最新50条
router.get('/getContribution_Fivety', function (req, res) {
  const Note_id = req.query.note_id;
  contributionListModel.find({ Note_id }, function (err, data) {
    if (!err) {
      if (data.length) {
...
//新建对应便签的投稿内容
router.post('/createNoteContribution', function (req, res) {
...
//删除对应便签的投稿内容
router.post('/noteContribution_delete', function (req, res) {
...
/* 指定便签主题下的标签列表 */
router.get('/noteDetails', function (req, res, next) {
...
/* 指定便签主题下的标签详情 */
router.get('/noteContent', function (req, res, next) {
  res.render('noteContent');
});
/* 指定便签主题下的标签详情-新建 */
router.get('/create_contribution', function (req, res, next) {
